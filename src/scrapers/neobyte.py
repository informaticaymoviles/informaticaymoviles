"""
Scraper para neobyte — usa el patrón genérico de src/scrapers/generic.py.
Los selectores concretos se definen en config/sites.yaml.

Se instancia desde scripts/run_weekly_update.py así:
    GenericStoreScraper(site_cfg, global_cfg, source_name="neobyte")

Si en el futuro neobyte necesita lógica especial (paginación distinta, JS
